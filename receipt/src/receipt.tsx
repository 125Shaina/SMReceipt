...
function Item({item}: {item: food})
{
    if (item.type === "cake")
    {
        ...
        else
        {
            ...
            {
                return <><img style = {{height: "50px", width: "50px"}}
                              src = "https://www.shutterstock.com/image-photo/selective-focus-square-red-velvet-260nw-1993396556.jpg"
                    />{cakeItem.flavor}{cakeItem.shape}{cakeItem.width}{cakeItem.length}{cakeItem.radius}</>;
            }
        }
    }
    else if (item.type === "cookie")
    {
        ...
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://tatyanaseverydayfood.com/wp-content/uploads/2014/12/Classic-Italian-Biscotti-4-768x1024.jpg"
            />{cookieItem.price}{cookieItem.quantity}{cookieItem.variety}</>;
        }
        else if(cookieItem.variety === "chocolate-chip")
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://assets.bonappetit.com/photos/5ca534485e96521ff23b382b/master/pass/chocolate-chip-cookie.jpg"
            />{cookieItem.price}{cookieItem.quantity}{cookieItem.variety}</>;
        }
        else if(cookieItem.variety === "white-chocolate-macadamia")
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://sallysbakingaddiction.com/wp-content/uploads/2012/09/white-chocolate-macadamia-nut-cookies-1.jpg"
            />{cookieItem.price}{cookieItem.quantity}{cookieItem.variety}</>;
        }
        else if (cookieItem.variety === "oatmeal-raisin")
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://www.eatingbirdfood.com/wp-content/uploads/2024/02/oatmeal-raisin-cookies-hero-new.jpg"
            />{cookieItem.price}{cookieItem.quantity}{cookieItem.variety}</>;
        }
        else
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://www.saveur.com/uploads/2011/12/14/Italian-Rainbow-Cookies-Recipe-Saveur-02-scaled.jpg?auto=webp"
            />{cookieItem.price}{cookieItem.quantity}{cookieItem.variety}</>;
        }
    ...
    else if (item.type === "doughnut")
    {
        ...
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://richanddelish.com/wp-content/uploads/2023/12/Boston-Cream-Donuts-1.jpg"
            />{doughnutItem.price}{doughnutItem.flavor}{doughnutItem.quantity}</>;
        }
        else if(doughnutItem.flavor  === "chocolate-glaze")
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src=  "https://www.rockrecipes.com/wp-content/uploads/2007/12/Choclate-glazed-homemade-donuts-on-white-serving-plate-480x480.jpg"
            />{doughnutItem.price}{doughnutItem.flavor}{doughnutItem.quantity}</>;
        }
        else if(doughnutItem.flavor  === "strawberry-frosted")
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://kitchenswagger.com/wp-content/uploads/2020/03/strawberry-frosted-doughnuts4.jpg"
            />{doughnutItem.price}{doughnutItem.flavor}{doughnutItem.quantity}</>;
        }
        else if (doughnutItem.flavor  === "chocolate-munchkin")
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://cosetteskitchen.com/wp-content/uploads/2019/03/munchkin-2-of-8-1-683x1024.jpg"
            />{doughnutItem.price}{doughnutItem.flavor}{doughnutItem.quantity}</>;
        }
        else if (doughnutItem.flavor  === "powdered-munchkin")
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://peanutbutterandjilly.com/wp-content/uploads/2020/11/IMG_5560-1-e1706652451106.jpg"
            />{doughnutItem.price}{doughnutItem.flavor}{doughnutItem.quantity}</>;
        }
        else
        {
            return<><img style = {{height: "50px", width: "50px"}}
                         src= "https://olivesnthyme.com/wp-content/uploads/2024/01/Powdered-Sugar-Donuts-18.jpg"
            />{doughnutItem.price}{doughnutItem.flavor}{doughnutItem.quantity}</>;
        }
    }
